...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/noc', label: 'NOC', superadminOnly: true, icon: 'M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 17a2 2 0 002 2h2a2 2 0 002-2m0 0V7m0 10a2 2 0 012 2h2a2 2 0 012-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2', featureKey: 'noc' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Rutas solo superadmin: un admin de condominio vuelve al panel
  useEffect(() => {
    if (user && user.rol !== 'superadmin' && (pathname.startsWith('/dashboard/noc') || pathname.startsWith('/dashboard/superadmin'))) router.replace('/dashboard')
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-3 space-y-4">
        {groups.filter(g => !g.superadminOnly || user?.rol === 'superadmin').map(group => {
          const visibleItems = group.items.filter(i =>
            (!i.superadminOnly || user?.rol === 'superadmin') &&
